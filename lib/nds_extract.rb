...
def movies_with_director_key(name, movies_collection)
  ...
  while counter < movies_collection.length do 
    new_array << movies_collection[counter]
    new_array[counter][:director_name] = name 
    counter += 1
  end
  new_array
end
...
counter = 0 
  while counter < source.length do 
    index = 0
    result << source[counter][:movies]
    result[counter][index][:director_name] = source[counter][:name]
    index += 1
    counter += 1
  end
  result
